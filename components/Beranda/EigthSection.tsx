    ...
    return (
        <div style={{ width: "100%", height: "692.3px", position: "relative", backgroundColor: "#091812", overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "flex-start", textAlign: "center", fontSize: "10px", color: "#f5edd6", fontFamily: "'Grazie mille'" }}>
            ...
            <motion.div
                ...
                style={{ alignSelf: "stretch", height: "1px", position: "relative", background: "linear-gradient(90deg, rgba(0, 0, 0, 0), rgba(201, 168, 76, 0.5) 50%, rgba(0, 0, 0, 0))" }}
            />
            ...
            >
                ...
                <motion.div
                    ...
                    style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", borderRadius: "50%", border: "0.7px solid rgba(201, 168, 76, 0.05)", boxSizing: "border-box", width: "280px", height: "280px" }}
                />
                <motion.div
                    initial={{ opacity: 0, scale: 0.5 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    ...
                    style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", borderRadius: "50%", border: "0.7px solid rgba(201, 168, 76, 0.05)", boxSizing: "border-box", width: "380px", height: "380px" }}
                />
                <motion.div
                    initial={{ opacity: 0, scale: 0.5 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    ...
                    style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", borderRadius: "50%", border: "0.7px solid rgba(201, 168, 76, 0.05)", boxSizing: "border-box", width: "480px", height: "480px" }}
                />
                ...
                >
                    <motion.div
                        ...
                        style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "center" }}
                    >
                    ...
                    <motion.div
                        ...
                        style={{ width: "100%", maxWidth: "672px", display: "flex", flexDirection: "column", alignItems: "center", padding: "16px 0px 0px", boxSizing: "border-box", fontSize: "56px", fontFamily: "Gilland" }}
                    >
                    ...
                    <motion.div
                        ...
                        style={{ width: "100%", maxWidth: "672px", display: "flex", flexDirection: "column", alignItems: "center", padding: "16px 0px 0px", boxSizing: "border-box", fontSize: "13px", color: "#c9b99a", textAlign: "center" }}
                    >
                    ...
                    <motion.div
                        ...
                        style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 0px 0px", textAlign: "left", fontSize: "12px", color: "rgba(201, 185, 154, 0.4)", fontFamily: "Montserrat" }}
                    >
                        <div style={{ height: "51.3px", display: "flex", alignItems: "flex-start", maxWidth: "448px", width: "100%" }}>
                            ...
                            <div style={{ alignSelf: "stretch", cursor: "pointer", background: "linear-gradient(256.8deg, #bda461, #fdde8a 24.52%, #bda461 50%, #fdde8a 75.48%, #bda461)", display: "flex", alignItems: "center", justifyContent: "center", padding: "16px 32px", gap: "8px", textAlign: "center", fontSize: "10px", color: "#091812", transition: "opacity 0.3s ease" }} className="hover:opacity-90">
            ...
            <div style={{ alignSelf: "stretch", backgroundColor: "#012421", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "64px 24px", textAlign: "left", fontSize: "9px", color: "#f8c56c", fontFamily: "Montserrat" }}>
                ...
                <div style={{ width: "1074px", position: "relative", maxWidth: "1280px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "24px" }}>
