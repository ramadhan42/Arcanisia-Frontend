...
const LoginModal: NextPage<LoginModalProps> = ({ isOpen, onClose }) => {
    if (!isOpen) return null;

    return (
        // Overlay Modal (Background Hitam Transparan, Posisi Center)
        <div
            style={{
                position: "fixed",
                inset: 0,
        ...
        >
            {/* Container Modal (Ukuran 80vw/80vh dengan batas maksimal dari UI asli agar letak UI tidak berubah) */}
            <div
                ...
                style={{
                    ...
                    overflow: "hidden",
                    display: "flex",
                    alignItems: "stretch", // Diubah menjadi stretch agar tinggi menyesuaikan otomatis
                    textAlign: "left",
                    fontSize: "28px",
                    color: "rgba(201, 185, 154, 0.6)",
                    fontFamily: "Gilland",
                    borderRadius: "12px", // Sedikit border radius agar lebih elegan (opsional)
            ...
            >
                <div style={{ height: "100%", width: "341.7px", position: "relative", backgroundColor: "#0d2a1a", overflow: "hidden", flexShrink: "0" }}>
                    ...
                    {/* Diperbaiki: left 0, width 100%, height 100% agar pas */}
                    <Image
                        ...
                        alt="Background"
                    />
                    {/* Diperbaiki: width & height 100% agar menyesuaikan parent div-nya */}
                    ...
                    <div style={{ position: "absolute", top: "249.1px", left: "40px", width: "261.7px", display: "flex", flexDirection: "column", alignItems: "flex-start", flexShrink: "0" }}>
                        <div style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                            <div style={{ position: "relative", lineHeight: "35px", background: "linear-gradient(256.8deg, #bda461, #fdde8a 24.52%, #bda461 50%, #fdde8a 75.48%, #bda461)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                                Kisah Wangi<br />Nusantara
                            </div>
                        </div>
                        <div style={{ width: "261.7px", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "12px 0px 0px", boxSizing: "border-box", fontSize: "15px", fontFamily: "'Grazie mille'" }}>
                            <div style={{ width: "276px", position: "relative", lineHeight: "22px", display: "inline-block", flexShrink: "0" }}>
                                Daftar dan nikmati pengalaman belanja eksklusif, akses koleksi terbaru, dan penawaran spesial anggota.
                            </div>
                        </div>
                    </div>
                ...
                <div style={{ height: "100%", flex: "1", overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "40px", boxSizing: "border-box", position: "relative", isolation: "isolate", maxHeight: "742.8px", textAlign: "center", fontSize: "26px", color: "rgba(201, 185, 154, 0.5)" }}>
                    <div
                        style={{
                            width: "100%", // Mengatur lebar parent menjadi 100%
                            height: "27.7px",
                            margin: "0",
                            // Menghapus absolute agar bisa diatur dengan flex
                            borderBottom: "0.7px solid rgba(201, 168, 76, 0.15)",
                            boxSizing: "border-box",
                            display: "flex",
                            alignItems: "flex-start",
                            justifyContent: "space-around", // Mengatur space antara MASUK dan DAFTAR
                            zIndex: "4",
                            flexShrink: "0",
                            fontSize: "10px",
                    ...
                    <div style={{ width: "398.3px", height: "85px", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "32px 0px 0px", boxSizing: "border-box", gap: "4px", zIndex: "1", flexShrink: "0", textAlign: "left" }}>
                        <div style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "flex-start", flexShrink: "0" }}>
                            <div style={{ position: "relative", lineHeight: "31.2px", background: "linear-gradient(256.8deg, #bda461, #fdde8a 24.52%, #bda461 50%, #fdde8a 75.48%, #bda461)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                                Selamat Datang
                            </div>
                        </div>
                    ...
                    <div style={{ width: "398.3px", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "28px 0px 0px", boxSizing: "border-box", zIndex: "2", flexShrink: "0", fontSize: "9px", fontFamily: "'Grazie mille'" }}>
                        ...
                        <div style={{ width: "398.3px", height: "31px", display: "flex", alignItems: "flex-start", justifyContent: "flex-end", padding: "16px 0px 0px", boxSizing: "border-box", fontSize: "10px" }}>
                            <div style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
                                <div style={{ position: "relative", letterSpacing: "1px", lineHeight: "15px" }}>Lupa password?</div>
                            </div>
                        </div>
                        <div style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "16px 0px 0px", fontSize: "11px", color: "#012421", cursor: "pointer" }}>
                            <div style={{ width: "398.3px", height: "44.5px", background: "linear-gradient(256.8deg, #bda461, #fdde8a 24.52%, #bda461 50%, #fdde8a 75.48%, #bda461)", display: "flex", alignItems: "center", justifyContent: "center", padding: "14px 0px", boxSizing: "border-box", gap: "8px" }}>
                                <div style={{ position: "relative", letterSpacing: "3.3px", lineHeight: "16.5px", fontWeight: "bold" }}>MASUK</div>
                            </div>
                        </div>
                        ...
                        <div style={{ alignSelf: "stretch", height: "122.7px", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "24px 0px 0px", boxSizing: "border-box", gap: "8px", fontSize: "11px", color: "#c9b99a" }}>
                            <div style={{ width: "398.3px", border: "0.7px solid rgba(201, 168, 76, 0.15)", boxSizing: "border-box", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 0px", gap: "12px", flexShrink: "0", cursor: "pointer" }}>
                                <div style={{ height: "21px", width: "21px", borderRadius: "13.52px", backgroundColor: "#fff", display: "flex", alignItems: "center", justifyContent: "center", boxSizing: "border-box" }}>

                                    {/* path logo public\gambar\login\google.svg */}
                                    <Image
                            ...
                            <div style={{ width: "398.3px", border: "0.7px solid rgba(201, 168, 76, 0.15)", boxSizing: "border-box", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 0px", gap: "12px", flexShrink: "0", cursor: "pointer" }}>
                                ...
                                {/* path logo public\gambar\login\facebook.svg */}
                                <Image
                                    src="/gambar/login/facebook.svg"
                                    style={{ height: "21px", width: "21px", position: "relative" }}
                                    width={21}
                                    height={21}
                                    sizes="100vw"
                                    alt="Facebook"
                    ...
                    <div style={{ alignSelf: "stretch", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "24px 0px 0px", zIndex: "3", flexShrink: "0", fontSize: "11px", color: "rgba(201, 185, 154, 0.4)", fontFamily: "'Grazie mille'" }}>
                        <div style={{ alignSelf: "stretch", height: "24px", position: "relative" }}>
                            ...
                            <div style={{ position: "absolute", top: "0px", left: "190.54px", width: "129.6px", height: "24px", fontSize: "16px", cursor: "pointer" }}>
                                <div style={{ position: "absolute", top: "0px", left: "5px", lineHeight: "24px", background: "linear-gradient(256.8deg, #bda461, #fdde8a 24.52%, #bda461 50%, #fdde8a 75.48%, #bda461)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                                    Daftar sekarang
                                </div>
                            </div>
                        </div>
